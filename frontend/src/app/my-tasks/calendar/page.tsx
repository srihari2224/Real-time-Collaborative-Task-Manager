...
import { tasksApi, type ApiTask } from '@/lib/apiClient';
...
export default function MyTasksCalendarPage() {
  ...
  const initialLoad = isPending && data === undefined;

  return (
    <>
      <style>{CSS}</style>
      <div className="wcal-root">
        <TopBar title="My Tasks Calendar" />
